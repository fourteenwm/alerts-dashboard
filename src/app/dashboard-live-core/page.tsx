...
export default function DashboardLiveCorePage() {
  ...
  useEffect(() => {
    if (fetchedData?.dashboardLiveCore) {
      setDashboardData(fetchedData.dashboardLiveCore)
    }
  }, [fetchedData])
  ...
  return (
    <DashboardLayout error={dataError ? 'Failed to load data. Please check your Sheet URL.' : undefined}>
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Dashboard Live Core - LivCor Accounts</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
  ...
  return (
    <div className="container mx-auto px-4 py-12 mt-16">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Dashboard Live Core - LivCor Accounts</h1>
      </div>
